...
export default {
  ...
  global: {
    ...
    message: 'text-[red] text-light-8 mb-1 text-xs pointer-events-none',
    messages: 'list-none p-0 mt-1 mb-0 pointer-events-none',
    outer: 'relative',
    prefixIcon:
  ...
  'family:dropdown': {
    ...
    placeholder: '',
    message: 'text-xs pl-2 text-light-8',
    selector:
      'relative flex w-full items-baseline min-h-[2.625em] [&u] cursor-pointer p-2 pt-5 gap-1 focus-visible:outline-0',
    selection:
      'flex w-full [&>.formkit-option]:p-0 !text-book-6 cursor-pointer ',
    selectedIcon: 'hidden',
    selectIcon: 'flex box-content h-5 w-5 cursor-pointer absolute right-2',
    wrapper: 'relative ',
    label: 'pl-2 font-light text-light-6',
  },
  'family:text': {
    inner: 'flex items-center max-w-md border-b pb-2 pt-5',
    input: 'w-full pl-2 border-none text-book-6 placeholder-[grey]',
    label: 'pl-2 font-light text-light-6',
    messages: 'absolute pb-xs top-full left-0 right-0 ',
    message: 'pl-2 text-light-8 !mb-0',
    outer:
      'focus-within:ring-primitives-blue focus-within:ring-1 [&>label:first-child]:focus-within:text-primitives-blue',
  },
  'family:date': {
    inner:
